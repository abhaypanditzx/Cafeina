...
const Top = () => {
  return (
    <div
    className={` bg-no-repeat bg-cover xs:bg-pink-bg max-xs:items-start bg-gradient-to-tr from-black to-gray-800  max-xs:bg-contain sm:h-[85vh] flex max-xs:h-[35vh] items-center max-xs:p-1 xs:p-5 justify-around `}
  >
    <div
    ...
    <div className="xs:w-[40%] max-xs:w-[100%]flex max-xs:h-[300px] xs:h-full max-xs:p-3 max-xs:justify-start items-start p-3 flex-col ">
      <div className=" max-xs:leading-[50px] xs:leading-[105px] ">
        <h1 className="lg:text-[100px] text-shadow tracking-tight xs:font-[500] max-xs:text-[40px] max-xs:font-[400] text-white sm:text-[60px]">
        COFFEE
        </h1>
