  ...
  return(
    ...
    <div className="flex flex-col max-xs:p-2 sm:p-5">
      ...
      <div className="flex mt-10  max-xs:mt-4 justify-around items-center">
        <h4 className="text-[15px] max-xs:text-[10px] font-semibold">{e.productPrice}</h4>
        <button className="px-5 py-1.5 max-xs:py-0.5 max-xs:px-2 sm:text-sm text-white font-semibold te bg-green-700 max-xs:text-[8px] sm:text-md w-max rounded-2xl ">
          Add Item
        </button>
      </div>
    </div>
